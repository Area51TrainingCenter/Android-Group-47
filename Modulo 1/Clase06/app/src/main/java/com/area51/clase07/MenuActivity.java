...
import com.area51.clase07.fragments.UsuarioFragment;
...
public class MenuActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView tvNombreHeader = view.findViewById(R.id.tvNombre);
        TextView tvGeneroHeader = view.findViewById(R.id.tvGenero);

        Usuario usuario = getIntent().getParcelableExtra("item");

        tvNombreHeader.setText(usuario.getNombre());
        tvGeneroHeader.setText(usuario.getGenero());
    }
